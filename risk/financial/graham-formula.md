...
- **Growth Estimate Sensitivity:** Small changes in the assumed growth rate (g) can dramatically swing the intrinsic value calculation, making it unreliable for companies with uncertain futures.
  - *How to address:* Use a conservative growth estimate — ideally the lower of the company's historical [5-year EPS CAGR](/risk/earnings/five-year-cagr.md) and the analyst consensus projection. Run the formula at multiple growth rates (e.g., g = 5%, 7%, 10%) to see how sensitive the result is. If intrinsic value doubles with a small change in g, the output is too unstable to trust.
...
- **Complementary Metrics:** Best used alongside [price-to-earnings](/risk/financial/price-to-earnings.md), [price-to-book](/risk/financial/price-to-book.md), [free cash flow](/risk/financial/free-cash-flow.md), and [earnings quality](/risk/earnings/earnings-quality.md) to build a complete picture of fundamental risk.
