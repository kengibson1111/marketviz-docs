...
| [Three-Month Return](financial/three-month-return.md) | How the 3-month Treasury yield serves as the risk-free rate in risk-adjusted models |
...
| [Standard Deviation](technicals/standard-deviation.md) | How return dispersion quantifies price unpredictability, risk-adjusted performance, and portfolio volatility |
...
| [Industry Relative Strength](experts/industry-relative-strength.md) | How industry-peer comparison reveals hidden laggards, validates breakouts, filters market noise, and identifies overbought traps |
| [Sector Relative Strength](experts/sector-relative-strength.md) | How sector-relative performance reveals true leadership, isolates systemic vs. company-specific risk, and identifies momentum-based entry points |
