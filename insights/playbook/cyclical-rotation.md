...
|-----------|----------------|-----------------|
| **Yield Curve (10Y − 2Y Treasury Spread)** | Inversion (negative spread) has preceded every U.S. recession since 1970. Steepening after inversion signals recovery is approaching. | [FRED: T10Y2Y](https://fred.stlouisfed.org/series/T10Y2Y) |
